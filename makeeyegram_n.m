%% makes a heatplot of eye positions in space
% written by naveen at JLG on 9/15/19


function FULLMAT1 = makeeyegram_n(eyex,eyey,res)

% res has to be 1,2,3 or 4
